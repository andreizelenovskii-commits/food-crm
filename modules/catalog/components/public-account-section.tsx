...
const ACCOUNT_FEATURES = [
  {
    kind: "loyalty",
    title: "Бонусы",
    text: "Ваш уровень и бонусный прогресс доступны после входа по номеру телефона.",
  },
  {
    kind: "profile",
    title: "Профиль",
    text: "Сохраняйте контакты и адреса доставки, чтобы оформлять заказы быстрее.",
  },
  {
    kind: "giveaways",
    title: "Розыгрыши",
    text: "Следите за акциями, условиями участия и подарками в личном кабинете.",
  },
] as const;
          ...
          <div className="flex flex-col justify-between rounded-[8px] border border-[#ffe0e3] bg-white p-6 shadow-sm shadow-[#d50014]/8 sm:p-8">
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-[#6b5960]">
                Войдите по SMS, чтобы видеть бонусы, сохранять адреса доставки
                и быстрее оформлять повторные заказы.
              </p>
            </div>
