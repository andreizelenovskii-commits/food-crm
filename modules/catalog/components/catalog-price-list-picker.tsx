...
export function CatalogPriceListPicker({
  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="rounded-[22px] border border-red-950/10 bg-white/62 p-1.5">
              ...
              <button
                ...
                className={`rounded-[18px] px-4 py-3 text-left transition ${
                  isSelected
                    ...
                    : "bg-transparent text-zinc-600 hover:bg-white/80 hover:text-red-900"
                }`}
              ...
              >
                <span className="flex items-start gap-3">
                  <span className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border text-[10px] font-semibold transition ${
                    isSelected ? "border-white/20 bg-white/16 text-white" : "border-red-100 bg-white text-red-800"
                  }`}>
