    ...
    <div className="mt-3 rounded-[18px] border border-[#f3dadd] bg-[#fffafa] p-4">
      ...
      <div className="mt-4 rounded-[14px] border border-dashed border-[#f1cfd3] bg-white px-4 py-3">
        ...
        <p className="mt-1 text-sm font-semibold text-[#7b5e64]">
          Анонсы и условия появятся в личном кабинете.
        </p>
      </div>
    </div>
  );
  ...
  if (!client) {
    return (
      <>
        ...
        <p className="mt-2 text-sm leading-6 text-[#6b5960]">
          Завершите вход по номеру телефона, и здесь появятся уровень лояльности
          и прогресс до следующего бонусного статуса.
        </p>
      </>
    );
  }
