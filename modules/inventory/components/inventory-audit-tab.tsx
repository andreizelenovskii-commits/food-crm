...
export function InventoryAuditTab({
  ...
  return (
    <div className="grid gap-4 xl:grid-cols-[0.62fr_1.38fr] xl:items-start">
      <div className="space-y-3">
        <section className="rounded-[22px] border border-white/70 bg-white/74 p-3 shadow-[0_18px_60px_rgba(127,29,29,0.08)] backdrop-blur-2xl sm:p-4">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-red-800/70">
            Инвентаризация
          </p>
          <h2 className="mt-1 max-w-[18rem] text-lg font-semibold leading-tight text-zinc-950">
        ...
        <section className="rounded-[22px] border border-white/70 bg-white/74 p-3 shadow-[0_18px_60px_rgba(127,29,29,0.08)] backdrop-blur-2xl sm:p-4">
          <h2 className="text-sm font-semibold text-zinc-950">Готовность команды</h2>
...
function AuditHeroStat({ label, value, hint }: { label: string; value: number; hint: string }) {
  return (
    <div className="rounded-[16px] border border-red-950/10 bg-white/80 p-3 shadow-sm shadow-red-950/5">
      ...
      <p className="mt-1.5 text-[10px] leading-4 text-zinc-500">{hint}</p>
    </div>
  );
}
...
function AuditStep({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="rounded-[16px] border border-red-950/10 bg-white/80 p-3 shadow-sm shadow-red-950/5">
      ...
      <p className="mt-1 text-[11px] leading-4 text-zinc-600">{children}</p>
    </div>
  );
}
