...
export function ProductForm({ initialProduct }: { initialProduct?: ProductItem }) {
  ...
  return (
    <form
      ...
      noValidate
      className="space-y-4 rounded-[22px] border border-white/70 bg-white/72 p-4 shadow-[0_18px_60px_rgba(127,29,29,0.10)] backdrop-blur-2xl"
    >
      ...
      <label className="block space-y-1.5">
        ...
        <div className="relative">
          <select
            ...
            className={`h-10 w-full appearance-none rounded-full border px-4 pr-12 text-sm font-medium outline-none transition focus:ring-2 ${
              selectedCategory
